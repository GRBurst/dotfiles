...
in rec {
  ...
  swayScreenMode = {
    ...
    bindings = [
      {
        key = "s";
        command = ''exec swaylock -f && swaymsg output '*' power off; mode "default"'';
      }
      {
        key = "p";
        command = ''exec swaylock -f && systemctl suspend; mode "default"'';
      }
      {
        key = "l";
        command = ''exec swaylock -f; mode "default"'';
      }
      {
        key = "o";
        command = ''exec swaymsg output '*' power off; mode "default"'';
      }
      {
        key = "r";
        command = ''exec swaymsg output '*' power on; mode "default"'';
      }
      {
        key = "Return";
